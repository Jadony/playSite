        ...
        records: [
          {
            ...
            spine: {
              json: "./src/assets/spine/王者荣耀.json",
              atlas: "./src/assets/spine/王者荣耀.atlas",
              png: "./src/assets/spine/王者荣耀.png",
            },
          ...
          },
          {
            ...
            spine: {
              json: "./src/assets/spine/无尽对决.json",
              atlas: "./src/assets/spine/无尽对决.atlas",
              png: "./src/assets/spine/无尽对决.png",
            },
          ...
          },
          {
            ...
            spine: {
              json: "./src/assets/spine/英雄联盟.json",
              atlas: "./src/assets/spine/英雄联盟.atlas",
              png: "./src/assets/spine/英雄联盟.png",
            },
          ...
          },
          {
            ...
            spine: {
              json: "./src/assets/spine/bh.json",
              atlas: "./src/assets/spine/bh.atlas",
              png: "./src/assets/spine/bh.png",
            },
            frontBgImage: "./src/assets/background/benghuaiFrontBg.png",
            behindBgImage: "./src/assets/background/benghuaiBehindBg.png",
            code: "yxlm",
          ...
          },
          {
            ...
            spine: {
              json: "./src/assets/spine/PUBG.json",
              atlas: "./src/assets/spine/PUBG.atlas",
              png: "./src/assets/spine/PUBG.png",
            },
            frontBgImage: "./src/assets/background/benghuaiFrontBg.png",
            behindBgImage: "./src/assets/background/benghuaiBehindBg.png",
            code: "pubgm",
  ...
  },
  {
    ...
    response: () => {
      return resolveResult([
        ...
        {
          gameId: 5,
          gameName: "Honkai: Star Rail111222",
          // Reusing yifuna for the third game for now as we only have 2 sets
          spine: {
            json: "./src/assets/spine/PUBG.json",
            atlas: "./src/assets/spine/PUBG.atlas",
